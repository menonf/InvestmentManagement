...
def test_value_at_risk() -> None:
    ...
    portfolio_var = risk.PortfolioVaR(portfolio_asset_returns, portfolio_latest_weights, "Portfolio_ABC", lookback_days=252, horizon_days=1, confidence_interval=0.95)
