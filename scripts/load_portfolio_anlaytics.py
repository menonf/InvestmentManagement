...
portfolio_asset_returns = perf.calculate_portfolio_asset_returns(portfolio_market_data, "close")["log_returns"]
portfolio_asset_weights = perf.calculate_portfolio_asset_weights(portfolio_market_data, "close", "market_weighted")
